...
Sub CATMain()
    ...
    '
    '----------------------------------------------------------------
    CATIA.StatusBar = "Hide_planes.bas, Version 1.0"    'Update Status Bar text
    ...
    selection1.Search "CatPrtSearch.Planes,All"                     'Search for all planes and select them
