Attribute VB_Name = "Create_splines_Unsafe"
Option Explicit

    '----------------------------------------------------------------
    '   Macro: Create_splines_Unsafe.bas
    '   Version: 1.0
    '   Code: CATIA VBA
    '   Release:   V5R32
    '   Purpose: Macro to create spline for points. This macro does not check and remove
    '           points that are two close, but has better preformance
    ...
    '----------------------------------------------------------------
Sub CATMain()
    CATIA.StatusBar = "Create_splines_Unsafe, Version 1.0"                         'Update Status Bar text
